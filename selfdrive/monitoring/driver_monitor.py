...
class DRIVER_MONITOR_SETTINGS():
  def __init__(self, TICI=TICI, DT_DMON=DT_DMON):
    ...
    self._AWARENESS_PRE_TIME_TILL_TERMINAL = 999999.
    self._AWARENESS_PROMPT_TIME_TILL_TERMINAL = 999999.
    self._DISTRACTED_TIME = 999999. # active monitoring total timeout
    self._DISTRACTED_PRE_TIME_TILL_TERMINAL = 999999.
    self._DISTRACTED_PROMPT_TIME_TILL_TERMINAL = 999999.
